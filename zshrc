...
# User configuration
export GEM_HOME="$PATH:$HOME/.gem"
export GEM_PATH="$PATH:$HOME/.gem"
...
alias cd424='cd ~/Documents/Q2/ngam-424'
alias cd423='cd ~/Documents/Q2/ngam-423'
alias cd422='cd ~/Documents/Q2/ngam-422'
alias cdA='cd ~/Documents/Q2/addons/'
